...
import {
  tests,
  usersTable,
} from "../../repos/drizzle-orm/integration-tests/tests/sqlite/sqlite-common.ts";

let db: SqliteRemoteDatabase;
let client: ReturnType<typeof createClient>;

// Detect if setReturnArrays is available (Deno 2.2+ should have this)
...
// Tests that require setReturnArrays for correct column ordering in joins
